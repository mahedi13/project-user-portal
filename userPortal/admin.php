...
else if(admin_available($userEmail, $userPassword, $con))
{
//$msgSuccess= "<div class='success'><center>Login Successful</center></div>";

header("location:adminMonitor.php");
}
else
{
...
<body id ='body-bg'>
  ...
  <a href='profile.php'><button class="btn btn-outline-success" style='margin-right:20px'><b><font color='black'>User Profile</font></b></button></a>
</div>
<div class="container">
 <div class='login-form col-md-4 offset-md-4'>

   <div class='jumbotron' style ='margin-top:20px; padding-top:20px; padding-bottom:10px'>
